...
export default class RadioactiveEnemy extends GameObject {
  game: Game;
  ...
  constructor({ game, position, velX = 5, velY = 5, maxRadius = 260, disableWallCollision = false }: TProps) {
    super({
      id: ENTITY_ID.RADIOACTIVE_AURA,
      width: 20,
      height: 20,
      position,
      velY,
