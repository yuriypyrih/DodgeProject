...
import BasicBoss from '../Basic/basic_boss.ts';
import TracerBoss from '../Tracer/tracer_boss.ts';
import BomberBoss from '../Bomber/bomber_boss.ts';
import VenomBoss from '../Venom/venom_boss.ts';
import SlimeBoss from '../Slime/slime_boss.ts';
import WormBoss from '../Worm/worm_boss.ts';
import GhostBoss from '../Ghost/ghost_boss.ts';
...
export default class MimicBoss extends GameObject {
  ...
  update(deltaTime: number) {
    ...
    if (
      ...
      (this.prevMimicked === 0 &&
        this.gameObject.position.x >= this.game.canvas.canvasWidth - this.gameObject.width - 10 &&
