...
export const getLevel13 = (game: Game): null => {
  if (game.spawner.executionSequence === 0) {
    if (game.spawner.roundTimer === sec(0.1)) {
      ...
      game.gameObjects.push(new WormEnemy({ game, position: { x: 750, y: 10 } }));
    } else if (game.spawner.roundTimer === sec(2.2)) {
      game.gameObjects.push(new WormEnemy({ game, position: { x: 600, y: 10 } }));
    } else if (game.spawner.roundTimer === sec(2.4)) {
      game.gameObjects.push(new WormEnemy({ game, position: { x: 450, y: 10 } }));
    } else if (game.spawner.roundTimer === sec(2.6)) {
      game.gameObjects.push(new WormEnemy({ game, position: { x: 300, y: 10 } }));
    } else if (game.spawner.roundTimer === sec(2.8)) {
      game.gameObjects.push(new WormEnemy({ game, position: { x: 150, y: 10 } }));
    } else if (game.spawner.roundTimer === sec(3)) {
      game.gameObjects.push(new SlimeEnemy({ game, position: { x: 1, y: 10 } }));
      game.gameObjects.push(new SlimeEnemy({ game, position: { x: 1, y: 200 } }));
      game.gameObjects.push(new SlimeEnemy({ game, position: { x: 1, y: 400 } }));
    ...
    if (game.spawner.roundTimer === sec(level13Stars[0] + 1.2)) {
      game.gameObjects.push(new VenomEnemy({ game, position: { x: 1, y: 20 } }));
      game.gameObjects.push(new VenomEnemy({ game, position: { x: 1, y: 350 } }));
    ...
    if (game.spawner.roundTimer === sec(level13Stars[1] + 1.2)) {
      game.gameObjects.push(new BomberEnemy({ game, position: { x: 1, y: 20 } }));
